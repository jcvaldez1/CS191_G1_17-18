...
#      Purpose of File: Schema for the database tables to be used


 # Variable Descriptions:
 #     food_stores = Creates the food_stores db table
 #     users = creates the users db table

ActiveRecord::Schema.define(version: 20180221132516) do
